...
import { a as FlexItem } from '../chunk-b1a95fe8.js';
import assign$1 from 'core-js/library/fn/object/assign';
import promise$1 from 'core-js/library/fn/promise';
...
var createDom = function createDom(ModalConstructor, opt) {
  var instance = new ModalConstructor();

  var instanceData = assign({}, defaultData, opt);
  ...
  Vue.prototype.$modal = function () {
    return {
      basic: function basic(opt) {
        var instance = createDom(ModalConstructor, opt);
        instance.type = 'basic';
        instance.show();
      },
